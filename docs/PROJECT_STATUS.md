...
- GitHub quality-gate workflow runs against PostgreSQL 16, with browser reports and traces retained as workflow artifacts. The current revision's result is attached to the PR.
