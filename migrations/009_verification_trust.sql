...
WHERE status='VERIFIED' AND (verification_policy IS NULL OR verification_policy NOT IN ('rangeform-verification-v2','rangeform-verification-v3-river1','rangeform-verification-v3-preflop1') OR verification_report IS NULL);
