...
export type StudyDashboard = { user: StudyUser; nlhe: NlheProgress; lessonCompleted: boolean; decisions: number; xp: number; averageRegret: number | null; bestDecisions: number; recent: { id: string; label: string; detail: string; createdAt: string }[]; daily: { date: string; decisions: number }[] };
...
import type { NlheProgress } from './nlhe';
